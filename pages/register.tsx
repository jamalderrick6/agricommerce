          ...
          <div className="form-block">
            ...
            <form className="form" onSubmit={createUser}>
              <div className="form__input-row">
                <input name="name" value={values.name} onChange={handleChange} className="form__input" placeholder="Full Name" type="text" />
              </div>
              
              <div className="form__input-row">
                <input name="email" value={values.email} onChange={handleChange} className="form__input" placeholder="Email" type="text" />
              </div>
              
              <div className="form__input-row">
                <input name="password" value={values.password} onChange={handleChange} className="form__input" type="Password" placeholder="Password" />
              </div>
